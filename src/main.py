...
def new_character():
    ...
    new_character = Characters(name=body["name"], gender=body["gender"], birth_year=body["birth_year"], home_planet=body["home_planet"])
...
def planet():
    ...
    planet = Planets(name=body["name"], population=body["population"], diameter=body["diameter"], climate=body["climate"])
